  ...
  return (
    <div>
      ...
      <section>
        ...
        <p className="text-lg leading-[1.361rem] text-center font-normal mt-[3rem] max-w-[49.5rem] mx-auto">
        ...
        <div className="mt-[3rem] flex justify-center gap-[3rem] ">
        ...
        <div className="mt-[8rem] flex justify-center gap-[3.6rem]">
          <div>
            <div>
              <Image
                priority
            ...
            <h1 className="font-medium text-lg leading-7 text-center">DAO Contributor</h1>
          ...
          <div>
            ...
            <h1 className="font-medium text-lg leading-7 text-center">DAO Leader</h1>
          ...
          <div>
            ...
            <h1 className="font-medium text-lg leading-7 text-center">New in Web 3.0?</h1>
        ...
        <div className="overflow-hidden mt-[10rem]">
            <h1 className="font-medium text-2xl leading-[1.813rem] text-center max-w-[49.5rem] mx-auto">Are you a Web3 advocate, and want to reward users with perks and other incentives? We’d love to hear from you!</h1>
        </div>
