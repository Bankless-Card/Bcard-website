...
const ForDaos = () => {
  return (
    <div>
      <Navbar />
      <section>
        <h1 className={`text-[2.25rem] leading-[2.723rem] font-semibold text-center ${styles['add-paddings']}`}>
          Give your community a way to support your cause.
        </h1>
        <p className={`text-lg leading-[1.361rem] text-center font-normal mt-[3rem] max-w-[49.5rem] mx-auto ${styles['add-paddings']}`}>
        ...
        <div className={`mt-[3rem] flex justify-center gap-[3rem] ${styles['card-group']}`}>
        ...
        <div className={`mt-[8rem] flex justify-center gap-[3.6rem] ${styles['card-group']}`}>
          <div>
            <div>
              <Image
                priority
            ...
            <h1 className={`font-medium text-lg leading-7 text-center ${styles['add-padding']}`}>DAO Contributor</h1>
          ...
          <div>
            ...
            <h1 className={`font-medium text-lg leading-7 text-center ${styles['add-padding']}`}>DAO Leader</h1>
          ...
          <div>
            ...
            <h1 className={`font-medium text-lg leading-7 text-center ${styles['add-padding']}`}>New in Web 3.0?</h1>
        ...
        <div className="overflow-hidden mt-[10rem]">
            <h1 className={`font-medium text-2xl leading-[1.813rem] text-center max-w-[49.5rem] mx-auto ${styles['hide-text']}`}>Are you a Web3 advocate, and want to reward users with perks and other incentives? We’d love to hear from you!</h1>
        </div>
