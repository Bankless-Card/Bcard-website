...
const ForInvestors = () => {
  return (
    <div>
      <Navbar />
      <section>
        <h1 className={`text-[2.25rem] leading-[2.723rem] font-semibold text-center ${styles['title-text']}`}>
          Powering the financial future of DAOs.
        </h1>
        <p className={`text-lg leading-[1.375rem] text-center font-normal mt-[3rem] max-w-[49.5rem] mx-auto ${styles['header-text']}`}>
        ...
        <div className={`flex justify-center gap-[2rem] mt-[3rem] ${styles['btn-group']}`}>
        ...
        <div className="overflow-hidden mt-[10rem]">
          <h1 className={`font-medium text-2xl leading-[1.813rem] text-center max-w-[49.5rem] mx-auto ${styles['header-text']}`}>
