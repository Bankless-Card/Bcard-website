    ...
    <>
      ...
      <div  className="flex justify-center items-center flex-col gap-[2rem] p-[4rem] relative">
        ...
        <div className="leading-[2rem] text-center px-[1rem]  md:px-[3.5rem] py-[1rem]">
            Keep an eye on your inbox for regular updates on our product! Meanwhile, follow Bankless on our social media to learn about other exciting stuff our vibrant community has in store! 
        </div>
      </div>
      <Footer />
    </>
